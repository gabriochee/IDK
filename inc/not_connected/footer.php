    ...
    <div class="container-fluid px-5">
        <div class="container-fluid d-md-flex justify-content-lg-center align-items-center border-bottom px-0">
            ...
            <div class="container-fluid col-7 fs-6">
                <ul class="nav justify-content-center justify-content-between">
                    <li class="nav-item">
                        <a <?php if(basename($_SERVER['PHP_SELF']) == 'questionnaire.php') echo 'class="nav-link text-decoration-underline text-white"'; ?> class="nav-link text-white" href="../../client/not_connected/questionnaire.php" class="nav-link text-white text-start">Questionnaire</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a <?php if(basename($_SERVER['PHP_SELF']) == 'terms_and_conditions.php') echo 'class="nav-link text-decoration-underline text-white"'; ?> class="nav-link text-white" href="../../client/not_connected/terms_and_conditions.php" class="nav-link text-white text-start">Conditions générales</a>
                    </li>
                    <li class="nav-item">
                        <a <?php if(basename($_SERVER['PHP_SELF']) == 'contact.php') echo 'class="nav-link text-decoration-underline text-white"'; ?> class="nav-link text-white" href="../../client/not_connected/contact.php" class="nav-link text-white text-start">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="container-fluid fw-light d-flex justify-content-center justify-content-evenly align-items-center p-2 m-0 border-bottom">
            <div class="container-fluid d-flex justify-content-center gap-3 align-items-center py-3">
                <p class="m-0 text-center text-nowrap">Inscrivez vous gratuitement</p>
