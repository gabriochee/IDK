...
try {
   ...
   echo '<div class="card"><div class="card-body d-flex justify-content-between"><input class="form-control me-2" maxlength="150" value="' . htmlspecialchars($_POST['question']) . '"><a class="btn btn-light collapsed" data-bs-toggle="collapse" href="#collapse0" role="button" aria-expended="false" aria-controls="#collapse0" aria-expanded="false">Réponses</a></div></div>';

    $result = $bdd->query('SELECT LAST_INSERT_ID();');
    $captchaId = $result->fetchAll()[0]['LAST_INSERT_ID()'];
    
    echo '<div id="collapse1" class="collapse show" style=""><div class="card card-body"><table class="table table-bordered"><tbody><tr><th>Réponses</th></tr>';
