...
$data_user1 = $bdd->prepare("SELECT id_user, nom, prenom, role_user, pseudo, sexe, date_naissance, date_inscription, statut_newsletter, telephone, mail FROM utilisateur WHERE id_user = :id_user;");
