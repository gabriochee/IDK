<?php
    ...
    if (isset($_GET['corps_message']) && isset($_GET['id_demande'])) {
        ...
        if ($recup_ticket2) {
            ...
            $send_demande = $bdd->prepare("INSERT INTO message_demande(id_user, id_admin, message, date_message, id_demande, statut_ticket,envoyeur,receveur,etre_message,etre_admin) VALUES(:id_user, :id_admin, :message, NOW(), :id_demande, :statut_ticket,:envoyeur,:receveur,1,0)");
            ...
            header("Location: demande_message_user.php?id_demande=$id_demande");
        }
    }
