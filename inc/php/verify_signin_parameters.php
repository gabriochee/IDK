...
} elseif (!preg_match("/^(19[0-9][0-9])|(20[0-1][0-9])|(202[0-4])$/", $_POST['birthday-year']) || !preg_match("/^(0?[1-9]$)|(1[0-2])$/", $_POST['birthday-month']) || !preg_match("/^(0?[1-9]$)|([1-2][0-9])|(3[0-1])$/", $_POST['birthday-day'])) {
...
} elseif (!preg_match("/^[a-zA-Z0-9]+(?:\.[a-zA-Z0-9]+)*@[a-zA-Z0-9]+(?:\.[a-zA-Z0-9]+)*$/", $_POST['email'])) {
