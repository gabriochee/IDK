    ...
    <main>
        <div class="container-fluid d-flex justify-content-center">
            <div class="d-flex flex-column my-5 py-2 gap-5 text-center">
                <img src="../../inc/logo.svg" alt="Logo IDK" width="200px" height="200px" class="img-thumbnail bg-transparent border-0">
        ...
        <div class="container col-9 mb-5">
            ...
            <p>Notre approche est simple : nous utilisons un questionnaire interactif, accessible à tous les utilisateurs, pour comprendre vos goûts cinématographiques. Ce questionnaire, composé d'une dizaine de questions, vous guidera à travers vos préférences et vos attentes. À la fin, vous recevrez une sélection personnalisée de 5 films ou séries qui correspondent le mieux à vos critères.
            <br>
            Mais notre personnalisation ne s'arrête pas là. Pour les utilisateurs connectés, nous offrons la possibilité de préciser davantage leurs préférences en fournissant une liste de films déjà visionnés et en ajoutant des critères supplémentaires. Cette étape permet d'affiner encore plus les recommandations et de les rendre uniques à chaque utilisateur.</p>
            <br>

            <h3>Une expérience sociale</h3>
            <p>En plus de vous proposer des recommandations sur mesure, notre plateforme se veut également sociale. Une fois inscrit ou connecté, vous accéderez à une interface conviviale où vous pourrez partager vos avis sur les films et séries que vous avez vus, constituer une liste de visionnage future, et découvrir les nouveautés correspondant à vos critères de prédilection.
            <br>
            Vous pourrez également interagir avec d'autres utilisateurs en les ajoutant à vos contacts, échanger des messages privés via notre système de messagerie intégré, et même partager vos découvertes cinématographiques avec eux.</p>
            <br>

            <h3>technologie et innovation</h3>
            <p>Le cœur de notre plateforme repose sur un modèle de classification des films et séries efficace et évolutif. Ce modèle, constamment mis à jour, est la clé de voûte de nos recommandations personnalisées, de la génération de notre newsletter hebdomadaire, et de l'affichage des nouveautés sur notre plateforme.Nous attachons également une grande importance à la convivialité de notre interface utilisateur.
            <br>
            Notre arbre de questions est conçu pour être intuitif et non intrusif, facilitant ainsi la création du compte utilisateur et le processus de recommandation.</p>
            <br>
            ...
            <h3>Notre mission</h3>
            <p>Chez IDK, nous croyons que chaque film et série mérite d'être découvert. Notre mission est de vous aider à trouver ces pépites cinématographiques qui enrichiront votre vie et stimuleront votre imagination.
            <br>
            Merci de faire partie de notre communauté et de nous permettre de vous accompagner dans votre voyage cinématographique.</p>
        </div>
    </main>
