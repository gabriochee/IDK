        ...
        <section>
            <div class="container">
                <div class="d-flex align-items-center my-2 ">
                    <img src="../../inc/profile.svg" alt="Logo IDK" class="container-fluid bg-transparent col-2 img-fluid col-lg-1 px-0">
                    <div class="col-10 col-lg-11">
                        <p class="display-5 fs-sm-4 fs-6">pseudo utilisateur</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container marketing">
                <h1 class="text-center m-5">Listes les plus populaires</h1>
