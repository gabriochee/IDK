                                ...
                                foreach ($fetch_newsletter as $newsletter) {
                                    ...
                                    echo '<td>
                                            <form action="edit_newsletter.php" method="POST">
                                                ...
                                                <button type="submit" name="update" class="btn btn-primary fs-4 mt-3">Mettre à jour</button>
                                            </form>
                                          </td>';
                                    echo '<td class="text-center">
                                            <form action="edit_newsletter.php" method="POST">
                                                <input type="hidden" name="id_newsletter" value="' . htmlspecialchars($newsletter["id_bloc"]) . '">
                                                <button type="submit" name="suppress" class="btn btn-primary fs-4 mt-3">Supprimer</button>
                                            </form>
                                          </td>';
                                    echo '<td class="text-center">
                                            <form action="edit_newsletter.php" method="POST">
