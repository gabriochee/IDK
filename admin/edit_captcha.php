            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container border border-black rounded-2 border-2 pb-2 mt-3">
                    ...
                    <div class="container-fluid px-0 mt-4">
                        ...
                        <button type="button" id="add-answer" class="nav-btn btn btn-warning text-white mt-3">+</button>
                        <button type="button" id="submit-captacha" class="nav-btn btn btn-success text-white mt-3" onclick="createCaptcha(this)">Enregistrer</button>
                    </div>
                </div>
            </main>
        </div>
